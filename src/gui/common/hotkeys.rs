...
use crate::gui::widget::{Container, Element, Row, Text, horizontal_space, vertical_space};
...
pub fn hotkeys<'a>() -> Element<'a, MainWindowEvent> {
    ...
    let content = crate::column![header, hotkeys, vertical_space(), actions]
        .spacing(10)
        .padding(15);
